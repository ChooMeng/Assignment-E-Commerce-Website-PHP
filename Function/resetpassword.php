<?php
    ...
    if ($con -> connect_errno) { //Check it is the connection succesful
        ...
        $sql = "SELECT * from resetpassword WHERE email='".$_GET["email"]."' AND resetCode='".$_GET['resetCode']."'";
        ...
        if (isset($_POST['newPasswordSubmit'])){
            ...
            if (empty($error)){
                ...
                if ($con -> connect_errno) { //Check it is the connection succesful
                    ...
                    $sql = "UPDATE client SET password=?, lastUpdate = ? WHERE email=?";
                    $stmt = $con->prepare($sql);
