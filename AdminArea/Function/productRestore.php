<?php
    ...
    //Display succesful restore product message
    if(isset($_SESSION["restored"])){
        echo '<script>setTimeout(function(){addNotification("green","<b>SUCCESFUL</b>! Restore the product.");}, 100);</script>';
    ...
    //Count total product amount of each status
    $totalCount = 0;
