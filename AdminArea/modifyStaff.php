...
<html>
    <head>
        ...
        <link href="CSS/modifyStaff.css" rel="stylesheet" type="text/css"/>
        <script src="JavaScript/modifyStaff.js" type="text/javascript"></script>
    </head>
    <body>
        <?php include 'header.php';?>
        <section>
            <div id="confirmationMessageProfile" class="confirmationMessage" title="Confirmation Message">
                <p>Do you want to save the edited staff profile?</p>
            </div>
            <div id="confirmationMessagePassword" class="confirmationMessage" title="Confirmation Message">
                <p>Do you want to change the staff password?</p>
            </div>
            <h1>Modify Staff Details</h1>
            <?php include 'Function/staffModify.php';?>
            <!--Navigation Bar for switching profile and changePassword section-->
            <div class="modifyMenu">
                <a id="profile" class="active" onclick="location.href='modifyStaff.php?staffId=<?php echo $staffID;?>&type=profile'">Profile</a>
                <a id="changePassword" onclick="location.href='modifyStaff.php?staffId=<?php echo $staffID;?>&type=password'">Change Password</a>
            </div>
            <!-- Profile Section: Display exist client details and allow edit-->
            <div class="profile">
                <form id="profileForm" action="modifyStaff.php?staffId=<?php echo $staffID;?>&type=profile" method="POST" >
                    <div class="rightSide">
                        ...
                        <input type="text" name="position" id="position" maxlength="40" value="<?php echo isset($_POST["position"])?$_POST["position"]:$position;?>">
            ...
            <div class="changePassword">
                <form id="changePasswordForm" action="modifyStaff.php?staffId=<?php echo $staffID;?>&type=password" method="POST">
